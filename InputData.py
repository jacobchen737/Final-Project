...
def get_trans_rate_matrix(with_treatment):
    ...
    [lambda9, 0, 0, 0, lambda6*rr, 0, lambda7*rr, 0, lambda0*(1/SCREEN_DURATION)*rr],  # WELL_SCREENING
    [0, 0, 0, lambda13, 0, lambda4*rr, 0, 0, lambda0],  # PRE_CANCER
